...
const Product = () => {
  ...
  return (
    <>
      <div className="text-center font-semibold text-2xl md:text-4xl pt-28">
      ...
      <div className="grid grid-cols-2  md:grid-cols-5 py-8 md:px-20 hover:cursor-pointer">
          ...
          return (
            ...
            >
              ...
              <div className="bg-white w-full p-2 absolute main-abso">
                <p className="text-slate-400 md:py-1 hover:underline hover:text-sky-900">
                  {item.category1}
                </p>
                <p className="md:py-1 hover:underline h-12 hover:text-sky-900">
                  {item.name}
                </p>
                <p className="py-6 md:py-1 text-red-600 font-bold">
                  {item.Now} ${item.price}
                  {item.del ? (
                ...
                <h1 className="py-1 md:py-3 flex gap-1 items-center justify-center">
                  <BsStar size={14} />
                  <BsStar size={14} />
                  <BsStar size={14} />
                  <BsStar size={14} />
                ...
                <div className="grid grid-cols-2 py-2   text-sky-900">
                  <button
                    ...
                    className="flex px-8 md:px-10 border-r-2"
                  >
                    <BsCartPlus size={16} />
                  </button>

                  <button className="flex px-8 md:px-10">
                    <GrOverview size={18} />
                  </button>
                </div>
              </div>
